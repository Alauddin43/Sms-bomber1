...
\033[1;92m[+] AUTHOR       :   Md. Alauddin islam
\x1b[1;92m[+] FACEBOOK     :   Md.Alauddin
\x1b[1;92m[+] GITHUB       :   alauddin43
\x1b[1;12m[+] TEAM         :   \33[1;42  NXN43\33[0m
...
if 'NXN'==user and 'NXN2'==pas:
        ...
        time.sleep(3)
        os.system('xdg-open https://www.facebook.com/profile.php?id=100090355360294')
        os.system("python NXN.py")
#
